...
<div id="mainframe">
    ...
    <div id="top">
        <div id="header_brandform">
			...
			<ul>
				<li><a href="/traders2/index.jsp">브랜드사이트</a></li>
				<li> | </li>
				<li><a href="/traders2/CEOindex.jsp">기업사이트</a></li>
			</ul>
  <div class="clear"></div>
        ...
        <div id="header_member">
            <ul>
                ...
                <li><a href="/traders2/join/CEOjoin.jsp">회원가입</a></li>
                <li> | </li>
                <li><a href="/traders2/join/CEOlogin.jsp">로그인</a></li>
            </ul>
        </div>
    ...
    <div id="mainmenu">
        <div id="logo"><a href="/traders2/index.jsp">CAFE TRADERS</a></div>
        <div id="menu">
            <ul>
                <li><a href=" /traders2/sellor/sellor_add.jsp">매장관리</a></li>
                <li><a href=" /traders2/CEOmanage/ordermanage.jsp">가게운영</a></li>
                <li><a href="/traders2/service/CEOservice.jsp">공지사항</a></li>
            </ul>
        </div>
    </div>
</div>