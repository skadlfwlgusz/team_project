...
<head>
<title>회원정보입력</title>
<link rel="stylesheet" href="../css/join/CEOjoin2.css">
	...
	<div id="Jmainframe2">
		...
		<div id="J2_frame">
			<table>
				<tr>
					<td>이메일</td>
					<td><input type="text" id="Txtmail" value="e-amail입력"></td>
					<td><input type="button" id="duple_ch" value="중복확인"></td>
				</tr>
				<tr>
					<td>성명</td>
					<td><input type="text" id="Txtname" value="이름입력"></td>
				</tr>
				<tr>
					<td>휴대폰</td>
					<td><input type="text" id="Txtph" value="핸드폰입력"></td>
				</tr>
				
				<tr>
					<td>생년월일</td>
					<td><input type="text" id="Txtbirth" value="생년월일입력(ex.901019)"></td>
				</tr>
				<tr>
					<td>사업자번호</td>
					<td><input type="text" id="Txtbirth" value="사업자번호입력(ex.'-'제외)"></td>
				</tr>
				<tr>
					<td>비밀번호</td>
					<td><input type="text" id="Txtpw" value="비밀번호입력"></td>
			...
			<div id="J_enter">
				<input type="button" value="가입하기" id="enter"
