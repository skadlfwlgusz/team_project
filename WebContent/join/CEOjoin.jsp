...
<meta charset="UTF-8">
<title>CEO약관동의</title>
<link rel="stylesheet" type="text/css" href="../css/join/CEOjoin.css">
...
<div id="ser7"><input type="button" value="가입하기" id="ser7_1" onclick="location.href='CEOjoin2.jsp';"></div> <br><br>
